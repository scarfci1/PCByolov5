...
def transfer_to_xml(pic, txt, file_name):
    xml_save_path = r'data\PCBDatasets\xml'
...
if __name__ == '__main__':
    ...
    txt_folder = r'data\PCBDatasets\txt'
    txt_file = os.listdir(txt_folder)
    img_folder = r'data\PCBDatasets\image'


    for txt in txt_file:
        txt_full_path = os.path.join(txt_folder, txt.split('.')[0] + '.txt')
